...
The current build slice is `0.1.29`. It produces Free and Pro DLLs from the
same source file:
...
buttons, and text fields, but 0.1.29 keeps the normal UI limited to daily
...
- `fa_radar.free.0.1.29.var`
- `fa_radar.pro.0.1.29.var`
